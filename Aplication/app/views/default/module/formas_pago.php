            ...
            <table id="datagrid" class="display" cellspacing="0" width="100%">
              <thead>
                  <tr>
                      ...
                      <th width="20%">Nombre Forma Pago</th>
                      <th width="25%">Descripción Forma Pago</th>
                ...
                <?php
                      ...
                      foreach($stmt as $row){
                        ...
                        echo "<tr>";
                          ...
                          echo "<td>".($row["forpag_nombre"])."</th>";
                          echo "<td>".($row["forpag_descripcion"])."</th>"; 
                          echo "<td>".$row["forpag_estado"]."</th>";
