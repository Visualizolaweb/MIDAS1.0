<?php
  ...
  $datos_cliente = Gestion_Clientes::ReadbyCC("43984605");
?>
...
<table>
 ...
 <tr>
    ...
    <td><input type="text" name="nombre_cliente" value="<?php echo $datos_cliente['cli_nombre']?>" size="15"></td>
 </tr>
 <tr>
    <td>Apellidos del cliente:</td>
    <td><input type="text" name="apellidos_cliente" value="<?php echo $datos_cliente['cli_apellido']?>" size="15"></td>
 </tr>
 <tr>
...
(
"unidades" => array("Lycra Ciclismo", "Plan platino"),
"productos" => array("1010", "2392"),
"precio_unidad" => array(90000, 320000)
);
$x = 0;
