...
class Gestion_Numeracion{
  ...
  function Create($num_codigo, $num_factura, $num_comprobantepago, $num_notacredito, $sede){

    $pdo = MIDAS_DataBase::Connect();
    $pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);

    $sql = "INSERT INTO ges_numeracion (num_codigo, num_factura, num_comprobantepago, num_notacredito, ges_sedes_sed_codigo) VALUES (?,?,?,?,?)";

    $query = $pdo->prepare($sql);
    $query->execute(array($num_codigo, $num_factura, $num_comprobantepago, $num_notacredito, $sede));
