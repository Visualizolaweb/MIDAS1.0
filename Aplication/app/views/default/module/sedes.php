          ...
          <div class="panel-body">
            <div class="btns-crud">
				...
				if($row_permiso["per_C"]==1){ ?>
              		<a href="dashboard.php?m=<?php echo base64_encode("module/sedes_nuevo.php");?>" class="btn btn-primary"><i class="fa fa-plus"></i> Nuevo laboratorio</a>
				<?php } ?>
					<a href="dashboard.php" class="btn btn-inverse"><i class="fa  fa-mail-reply"></i> Volver al Inicio</a>
                ...
                <?php
                      ...
                      foreach($stmt as $row){
                        ...
                        echo "<tr>";
                          ...
                          echo "<th style='text-align:left;'>$row[2]</th>";
                          echo "<th>$row[3]</th>";
                          echo "<th>$row[7]</th>";
                          echo "<th>
						  ...
						  if($row_permiso["per_R"]==1){
						  	 echo " <a href='dashboard.php?m=".base64_encode("module/sedes_detalle.php")."&pid=".base64_encode($row[0])."' type='button' class='btn btn-info'><i class='fa fa-search-plus'></i> Detalle</a>    ";
						  }
						  if($row_permiso["per_U"]==1){
							 echo " <a href='dashboard.php?m=".base64_encode("module/sedes_editar.php")."&pid=".base64_encode($row[0])."' type='button' class='btn btn-success'><i class='fa fa-pencil'></i> Editar</a>";
						  }
