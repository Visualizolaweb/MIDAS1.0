			...
			if(navMenu.hasClass("mm-vertical")){
				...
				navMenu.find("ul").each(function(i) {
					if(i==0){
						...
						$(this).removeClass("tooltip-area, mm-subopened, mm-hidden").addClass("mm-current");
					}else{

						$(this).removeClass("tooltip-area, mm-opened, mm-subopened, mm-current, mm-highest").addClass("mm-hidde");
					}
				});
			}
		}
