        ...
        <div class="panel">
          <header class="panel-heading">
            ...
            <?php if($row_permiso["per_C"]==1){ ?>
                  	<a href="dashboard.php?m=<?php echo base64_encode("module/usuarios_nuevo.php");?>" class="btn btn-primary"><i class="fa fa-plus"></i> Nuevo Usuario</a>
    				<?php } ?>
